...
// Consulta SQL base
$sql = "SELECT c.id, c.nombre AS categoria, 'Comunidad Estudiantil' AS dimension
        FROM categorias c
...
$colorDimension = 'card-blue'; // Color para Comunidad Estudiantil
$iconos = ['fa-users', 'fa-handshake', 'fa-comments', 'fa-user-graduate'];
?>
<!DOCTYPE html>
<html lang="es">
